...
By looking at how long something has been failing for, Flapjack limits the effects of latency on the observation interval, and provides alerts to humans about problems faster. 
