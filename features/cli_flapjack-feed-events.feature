...
"""
  ...
  Scenario: Running flapjack-feed-events with no arguments and no STDIN fails with a warning
    When I run `bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json`
...
"""
    When I run `cat tmp/cucumber_cli/single-event.json | bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json`
    Then the exit status should be 0
    ...
    When I run `bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json -f tmp/cucumber_cli/single-event.json`
    Then the exit status should be 0
    And  the output should not contain "Invalid event data received"
    And  the output should contain "Enqueued event data, "
    And  the output should contain "client1-localhost-test-1"
...
"""
    When I run `cat tmp/cucumber_cli/multiple-events.json | bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json`
    Then the exit status should be 0
    And  the output should not contain "Invalid event data received"
    And  the output should contain "Enqueued event data, "
    And  the output should contain "client1-localhost-test-1"
    ...
    When I run `bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json -f tmp/cucumber_cli/multiple-events.json`
    Then the exit status should be 0
    And  the output should not contain "Invalid event data received"
    And  the output should contain "Enqueued event data, "
    And  the output should contain "client1-localhost-test-1"
...
"""
    When I run `cat tmp/cucumber_cli/invalid-events.json | bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json`
    Then the exit status should be 0
...
{"entity": "client1-localhost-test-2", "check": "bar"}
"""
    When I run `cat tmp/cucumber_cli/invalid-json.json | bundle exec bin/flapjack -n test -c tmp/cucumber_cli/flapjack-feed-events.toml receiver json`
    Then the exit status should be 1
    And  the output should not contain "Enqueued event data, "
