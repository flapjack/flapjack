...
describe Flapjack::Gateways::SmsTwilio, :logger => true do
  ...
  it "sends an SMS message" do
    req = stub_request(:post, "https://api.twilio.com:443/2010-04-01/Accounts/the_account_sid/Messages.json").
  ...
  it "does not send an SMS message with an invalid config" do
    ...
    expect(WebMock).not_to have_requested(:post,
      "https://api.twilio.com:443/2010-04-01/Accounts/the_account_sid/Messages.json")
  end
