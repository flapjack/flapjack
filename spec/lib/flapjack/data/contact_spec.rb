...
describe Flapjack::Data::Contact, :redis => true do
  ...
  let(:general_notification_rule_data) {
    {:entities           => [],
     ...
     :time_restrictions  => [],
     :unknown_media      => [],
     :warning_media      => ['email', 'sms', 'sms_twilio', 'sms_gammu', 'sms_nexmo', 'jabber', 'pagerduty', 'sns'],
     :critical_media     => ['email', 'sms', 'sms_twilio', 'sms_gammu', 'sms_nexmo', 'jabber', 'pagerduty', 'sns'],
     :unknown_blackhole  => false,
     :warning_blackhole  => false,
     :critical_blackhole => false}
  }
