...
describe Flapjack::Data::ContactR, :redis => true do
  ...
  it "returns a list of all contacts" do
    ...
    sorted_contacts = contacts.sort_by {|c| [c.last_name, c.first_name]}
    sorted_contacts[0].name.should == 'Jane Janeley'
    sorted_contacts[1].name.should == 'John Johnson'
  end

  it "finds a contact by id" do
    contact = Flapjack::Data::ContactR.find_by_id('362')
  ...
  it "deletes all contacts" do
    expect {
      Flapjack::Data::ContactR.delete_all
    }.to change { Flapjack::Data::ContactR.count }.from(2).to(0)
  end
