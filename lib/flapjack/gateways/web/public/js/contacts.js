...
$( document ).ready(function() {
  ...
  app.ContactListItem = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.$el.find('div.contact_entities_view').empty().append( entitiesEnabled.$el );
  ...
  contacts.fetch({success: function(coll, response, options) {
    var actionsView = new app.ActionsView({collection: coll});
    var contactList = new app.ContactList({collection: coll});
