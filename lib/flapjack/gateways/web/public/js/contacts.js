$(document).ready(function() {
  ...
  app.ActionsView = Backbone.View.extend({
    ...
    addContact: function() {
      ...
      $('#contactModal button.btn.btn-success').on('click', function() { context.save(); });
  ...
  app.ContactView = Backbone.View.extend({
    ...
    id: 'contactView',
    events: {
      'change input[name=contact_first_name]': 'changeFirstName',
      'change input[name=contact_last_name]': 'changeLastName',
      'change input[name=contact_email]': 'changeEmail',
    },
